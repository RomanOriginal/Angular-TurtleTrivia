(function(){
    ...
    var quizQuestions  = [
        ...
        },
        {
            ...
            possibilities: [
                {
                    answer: "https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcSRQV3zGdT1Q-k0kedtIwAFNOfKSQCDbCMwDYLM2Wj-gUXc-kDM"
                },
                {
    ...
    var turtlesData = [
        {
            type: "Green Turtle",
            image_url: "https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcSRQV3zGdT1Q-k0kedtIwAFNOfKSQCDbCMwDYLM2Wj-gUXc-kDM",
